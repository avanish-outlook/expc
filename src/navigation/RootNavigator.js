...
import { Accounts, CreateAccount, CreatePost, CreateReel, EditAccount, EditProfileScreen, LoginScreen, MainScreen, Records, RegisterScreen, SplashScreen } from '../screens'
...
<Stack.Screen
      name={ScreenRoutes.RecordScreen.name}
      options={{ headerShown: false, title: 'Records' }}
      component={Records}
    />
