...
const PostCard = ({ item }) => {
    ...
    const openProfile = () => {
        console.log(user.userId, post.userId._id)
        if (post.userId === user.userId._id) {
        ...
        <View style={styles.container}>
            <View style={styles.header} >
                <TouchableOpacity onPress={openProfile}>
                    ...
                    <Image source={post.userId.profilePic !== '' ? { uri: config.BACKEND_HOST_URL + post.userId.profilePic }
